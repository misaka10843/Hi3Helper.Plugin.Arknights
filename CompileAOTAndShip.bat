@echo off
set _pluginName=Hi3Helper.Plugin.Arknights
...
mkdir "%outputDirPath%"
cd "%projectPath%"
dotnet restore --runtime win-x64 ..\Hi3Helper.Plugin.Arknights.sln || goto :Error
dotnet clean --configuration %configuration% --runtime win-x64 ..\Hi3Helper.Plugin.Arknights.sln || goto :Error
