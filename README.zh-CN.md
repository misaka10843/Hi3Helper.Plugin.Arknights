...
**明日方舟** · [明日方舟：终末地](https://github.com/misaka10843/Hi3Helper.Plugin.Endfield)

为 [Collapse Launcher (Collapse 启动器)](https://collapselauncher.com/) 开发的第三方插件，旨在支持 **《明日方舟》**
的下载、更新与启动。
...
- [ ] **全球服支持**：官方暂未为全球服提供PC版，需等待官方支持后适配
...
1. **下载插件**
   前往 [Releases 页面](https://github.com/misaka10843/Hi3Helper.Plugin.Arknights/releases/latest) 下载最新的插件压缩包（
   `.zip` 文件）。
