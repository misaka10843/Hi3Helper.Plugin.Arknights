...
public partial class ArknightsCnPresetConfig : PluginPresetConfigBase
{
    ...
    {
        get => field ??= new ArknightsLauncherApiMedia(ExWebApiUrl, ExAppCode, ExChannel, ExSubChannel, ExSeq);
        set;
    }

    public override ILauncherApiNews? LauncherApiNews
    {
        get => field ??= new ArknightsLauncherApiNews(ExWebApiUrl, ExAppCode, ExChannel, ExSubChannel, ExSeq);
        set;
    }

    public override IGameManager? GameManager
    {
        get => field ??= new ArknightsGameManager(ExEcutableName, ExApiUrl, ExWebApiUrl, ExAppCode, ExLauncherAppCode,
    ...
    {
        get => field ??= new ArknightsGameInstaller(GameManager!);
        set;
    }
